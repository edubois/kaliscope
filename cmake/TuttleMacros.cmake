...
function(tuttle_ofx_plugin_target PLUGIN_NAME)
    ...
    if(TuttleBoost_FOUND)
        ...
        target_link_libraries( ${PLUGIN_NAME} ${Boost_LIBRARIES} tuttlePlugin-static )
        ...
        # FIXME: why tuttlePlugin-static depends on OpenGL ? is it necessary ?
        if(APPLE)
            find_package(OpenGL)
        ...
        set(OFX_PLUGIN_ROOT "${CMAKE_INSTALL_PREFIX}/mvpPlayerPlugins/OFX/${PLUGIN_NAME}${_plugin_version_suffix}.ofx.bundle/Contents")
        tuttle_ofx_architecture(OFX_ARCH)

        # Set RPATH for installed libraries like boost 
        set(CMAKE_BUILD_WITH_INSTALL_RPATH FALSE) 
        set(CMAKE_INSTALL_RPATH "${OFX_PLUGIN_ROOT}/${OFX_ARCH}/")
